...
//import static com.dingi.dingisdk.TelemetryEnabler.TELEMETRY_STATES;
...
public class AppUserTurnstile extends Event implements Parcelable {
    ...
    private static final String APPLICATION_CONTEXT_CANT_BE_NULL = "Create a DingiTelemetry instance before calling "
            + "this method.";

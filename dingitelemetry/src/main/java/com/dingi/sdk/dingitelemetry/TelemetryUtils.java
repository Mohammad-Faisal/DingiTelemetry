...
public class TelemetryUtils {
    static final String DINGI_SHARED_PREFERENCES = "DingiSharedPreferences";
    static final String DINGI_SHARED_PREFERENCE_KEY_VENDOR_ID = "dingiVendorId";
     ...
     */
    //changed
    static String retrieveVendorId(Context context) {
        /*if (DingiTelemetry.applicationContext == null) {
        ...
        String dingiVendorId = sharedPreferences.getString(DINGI_SHARED_PREFERENCE_KEY_VENDOR_ID, "");
        if (TelemetryUtils.isEmpty(dingiVendorId)) {
            dingiVendorId = TelemetryUtils.updateVendorId(context);
        }
        return dingiVendorId;
    }

    static SharedPreferences obtainSharedPreferences(Context context) {
        return context.getSharedPreferences(DINGI_SHARED_PREFERENCES, Context.MODE_PRIVATE);
    }

    private static String updateVendorId(Context context) {
        ...
        editor.putString(DINGI_SHARED_PREFERENCE_KEY_VENDOR_ID, uniqueId);
        editor.apply();
        return uniqueId;
    }
